...
export default function JoinGame() {
  ...
  const howToPlayScreen = (
    <>
      ...
      <Box style={{width: '100%'}}>
        <Swiper modules={[Pagination]} slidesPerView={1} style={{width:'100%'}}  pagination={{
          ...
          <SwiperSlide style={{display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center'}}>
            <div style={{position: 'absolute', height: '100%', width: '100%'}}>
              <Monster src={HowToPlay_Phase1Circle} alt="monster"  sx={{position: 'absolute', top: '40px', left: '210px', height: '70px', width: '70px'}}/>
              <Monster src={HowToPlay_OrangeMonster} alt="monster" sx={{position: 'absolute', bottom: '45px', left: '110px', width: '200px', height: 'auto'}}/>
            </div>
            <Monster src={HowToPlay1_Screenshot} alt="monster" />
          ...
          <SwiperSlide style={{display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center'}}>
            <div style={{position: 'absolute', height: '100%', width: '100%'}}>
              <Monster src={HowToPlay_Phase1Circle} alt="monster"  sx={{position: 'absolute', top: '40px', left: '210px', height: '70px', width: '70px'}}/>
              <Monster src={HowToPlay_RedMonster} alt="monster" sx={{position: 'absolute', bottom: '60px', left: '420px', width: '115px', height: 'auto'}}/>
            </div>
            <Monster src={HowToPlay1_Screenshot} alt="monster" />
          ...
          <SwiperSlide style={{display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center'}}>
            <div style={{position: 'absolute', height: '100%', width: '100%'}}>
              <Monster src={HowToPlay_Phase1Circle} alt="monster"  sx={{position: 'absolute', top: '40px', left: '210px', height: '70px', width: '70px'}}/>
              <Monster src={HowToPlay_GreenMonster} alt="monster" sx={{position: 'absolute', bottom: '80px', left: '180px', width: '90px', height: 'auto', zIndex: -1}}/>
              <Monster src={HowToPlay_PinkMonster} alt="monster" sx={{position: 'absolute', bottom: '80px', left: '430px', width: '90px', height: 'auto'}}/>
            </div>
            <Monster src={HowToPlay1_Screenshot} alt="monster" />
          ...
          <SwiperSlide style={{display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center'}}>
            <div style={{position: 'absolute', height: '100%', width: '100%'}}>
              <Monster src={HowToPlay_Phase2Circle} alt="monster"  sx={{position: 'absolute', top: '40px', left: '210px', height: '70px', width: '70px'}}/>
              <Monster src={HowToPlay_PinkMonster2} alt="monster" sx={{position: 'absolute', bottom: '90px', left: '400px', width: '90px', height: 'auto'}}/>
            </div>
            <Monster src={HowToPlay1_Screenshot} alt="monster" />
          ...
          <SwiperSlide style={{display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center'}}>
            <div style={{position: 'absolute', height: '100%', width: '100%'}}>
              <Monster src={HowToPlay_BlueMonster} alt="monster" sx={{position: 'absolute', top: '30px', left: '370px', width: '140px', height: 'auto', zIndex: -1}}/>
            </div>
            <Monster src={HowToPlay1_Screenshot} alt="monster" />
            <Typography variant="h2" sx={{textAlign: 'center', paddingTop: `${theme.sizing.mediumPadding}px`, width: '350px' }}> Gain more points by guessing the most popular incorrect answer! </Typography>
          </SwiperSlide>
  ...
  return (
    ...
    <IntroContainer>
        ...
        :
          ...
          //   {avatarSelectScreen}
          // </StackContainer>
            <HowToPlayContainer sx={{justifyContent: 'space-between', height: '100%', paddingBottom: `${theme.sizing.largePadding}px`}}>
            {howToPlayScreen}
          </HowToPlayContainer>
        }
    </IntroContainer>
