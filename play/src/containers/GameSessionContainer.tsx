  ...
  return (
    ...
    <>
      <div style={{position: 'absolute', top: 0, left: 0, zIndex: 5}}>
        <div>
        <input type="radio" name="option" value="0" checked={joinGamePhase === 0} onChange={handleOptionChange} />
        <input type="radio" name="option" value="1" checked={joinGamePhase === 1} onChange={handleOptionChange} />
        <input type="radio" name="option" value="2" checked={joinGamePhase === 2} onChange={handleOptionChange} />
        <input type="radio" name="option" value="3" checked={joinGamePhase === 3} onChange={handleOptionChange} />
        <input type="radio" name="option" value="4" checked={joinGamePhase === 4} onChange={handleOptionChange} />
      </div>
      </div>
