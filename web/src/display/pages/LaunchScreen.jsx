    ...
    return(
        <div className={classes.page}>
            ...
            <div className={classes.startGame}>
                ...
                <div onClick={() => history.push(`/display/mobilepair`)}> <p style={{color: '#0075FF', textDecoration: 'underline', fontSize: '24px', cursor: 'pointer' }}> Teachers: Got a mobile device? Click here to pair it!</p></div>
            </div>
        </div>
    )
};
