...
export default function PlayersAnsweredBar({numPlayers, numPlayersAnswered, progressPercent}) {
      ...
      <div className={classes.bargroup}>
        <div className={classes.barContainer}>
          <LinearProgress variant='determinate' classes={{ colorPrimary: classes.colorPrimary, barColorPrimary: classes.barColorPrimary }} className={classes.progressBar} value={progressPercent}></LinearProgress>
           <div style={{ position: 'absolute', top: '0', left: '0', width: `${progressPercent - 2}%`, textAlign: 'right', fontFamily: 'Helvetica', fontSize: '12px', fontWeight: 'bold', zIndex: '1', lineHeight: '18px' }}> {numPlayersAnswered} </div>
        </div>
