  ...
  return (
    ...
    >
      ...
      <StyledFlexBox direction="column" gap={48}>
        {/* Title */}
        <StyledText fontSize="24px" fontWeight={700} lineHeight={1.3}>
        ...
        <StyledFlexBox direction="column" gap={24}>
          ...
          <StyledFlexBox direction="row" gap={24}>
            <StyledFlexBox>
              <StyledText
                sx={{
                  ...
                  background:
                    'linear-gradient(rgba(118, 35, 116, .49) 9%, rgba(118, 35, 116, 0) 100%)',
            ...
            <StyledFlexBox gap={24}>
              <StyledText fontWeight={700} fontSize="20px">
                Uncover the &quot;why&quot;
              </StyledText>
              <Typography
                fontFamily="Rubik"
                ...
                sx={{ color: '#fff' }}
              >
                Mistake allows teachers to better address gaps in student
                understanding and highlight alternative strategies.
              </Typography>
            </StyledFlexBox>
          </StyledFlexBox>
          ...
          <StyledFlexBox direction="row" gap={24}>
            ...
            <StyledFlexBox gap={24}>
              ...
              <Typography
                ...
                sx={{ color: '#fff' }}
              >
                Classrooms are safe spaces to make errors and students feel more
                confident to take risks and engage in challenging problems.
              </Typography>
            </StyledFlexBox>
          </StyledFlexBox>
          ...
          <StyledFlexBox direction="row" gap={24}>
            ...
            <StyledFlexBox gap={24}>
              ...
              <Typography
                ...
                sx={{ color: '#fff' }}
              >
                Research shows that confronting these misunderstandings head-on
                leads to lasting comprehension.
              </Typography>
            </StyledFlexBox>
          </StyledFlexBox>
        </StyledFlexBox>
      ...
      <StyledFlexBox
        ...
        sx={{
          ...
          borderRadius: '12px',
          background:
            'linear-gradient(rgba(2, 33, 95, 1) 43%, rgba(2, 33, 95, 0) 100%)',
        }}
      >
        ...
        >
          <StyledText fontWeight={700} fontSize="20px" textAlign="center">
            Sample Question
          </StyledText>
          <Typography
            fontFamily="Rubik"
            ...
            sx={{ color: '#fff' }}
          >
            Someone in Philadelphia says, “Pass me that jawn real quick.” What
            are they most likely referring to?
          </Typography>
