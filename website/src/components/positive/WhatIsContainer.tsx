      ...
      case ScreenSize.MEDIUM:
        return (
          ...
          >
            ...
            >
              {/* TODO: title text */}
              <Typography sx={{ width: '100%', lineHeight: '1.2', fontSize: '40px', fontFamily: 'Poppins, sans-serif', fontWeight: 700,   color: '#FFFFFF', textAlign: 'left'}}>What is a Positive Culture of Error?</Typography>
              <Box
                style={{
                  display: 'flex',
                  flexDirection: 'column',
