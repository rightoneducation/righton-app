...
function generateUniqueID() {
  ...
  let randomID = '';
  if (coinFlip === 0) {
    randomID = `${Math.ceil(Math.random() * 9)}${Math.floor(Math.random() * 10)}${Math.ceil(Math.random() * 9)}${Math.floor(Math.random() * 10)}${Math.ceil(Math.random() * 9)}${Math.floor(Math.random() * 10)}`;
  } else {
    randomID = `${Math.ceil(Math.random() * 9)}${Math.ceil(Math.random() * 9)}${Math.floor(Math.random() * 10)}${Math.ceil(Math.random() * 9)}${Math.floor(Math.random() * 10)}${Math.ceil(Math.random() * 9)}`;
  }
  return randomID;
}
