...
export const IOTSubscribeToTopic = (topic, messageHandler) => {
  attachIotPolicy()
    .then(() => {
...
export const unsubscribeFromTopic = () => {
  subscribedTopic.unsubscribe && subscribedTopic.unsubscribe();
  subscribedTopic = {};
  console.log('Unsubscribed from topic');
};

export const publishMessage = async (topic, message) => {
  await PubSub.publish(topic, { msg: message }).catch(e => console.log('Error sending message', e));
