  ...
  return (
    <div className={classes.helpWrapper}>
      <div
        ...
        onClick={() => {
          SetIsHelpMenuClicked((prev) => !prev);
        }}
      >
        <Tooltip
          title="Help"
        ...
        >
          {!isHelpMenuClicked ? (
            <img
              src={HelpMenuIcon}
              className={classes.helpMenuTitleIcon}
              alt="Help Menu Icon"
            />
          ) : (
            <img
              src={HelpMenuIconClicked}
              className={classes.helpMenuTitleIcon}
              alt="Help Menu Icon Clicked"
            />
          )}
        </Tooltip>
      </div>
      <Collapse in={isHelpMenuClicked} timeout={0}>
        <div className={classes.helpBody}>
          <table width="100%">
            <tbody>
              <tr
                className={classes.helpTableRow}
                onClick={() => {
                  SetIsHelpMenuClicked((prev) => !prev);
                  history('/');
                }}
              ...
              <tr
                ...
                onClick={() => {
                  SetIsHelpMenuClicked((prev) => !prev);
                  handleModalOpen(true, false);
                }}
              >
                <td>
                  <img
                    src={HelpMenuHelpIcon}
                    className={classes.helpIcon}
                    alt="Help Icon"
                  />
                </td>
              ...
              <tr
                ...
                onClick={() => {
                  SetIsHelpMenuClicked((prev) => !prev);
                  window.location = '//www.rightoneducation.com/';
                }}
              >
                <td>
                  <img
                    src={HelpMenuAboutIcon}
                    className={classes.helpIcon}
                    alt="About Icon"
                  />
                </td>
...
const useStyles = (isHelpMenuClicked) =>
  makeStyles((theme) => ({
    helpWrapper: {
      color: 'white',
      fontFamily: 'Poppins',
