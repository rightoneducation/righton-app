...
export default function QuestionFormAnswerDropdown({
  ...
  return (
    <Grid item xs={12}>
      <Card
        className={choice.isAnswer ? classes.correctCard : classes.wrongCard}
      >
        <CardContent
          style={{ display: 'flex', justifyContent: 'space-between' }}
        >
          <Typography className={classes.answer}>
            {index === 0 ? 'Correct answer:' : `Wrong Answer ${index}:`}
          </Typography>
          <TextField
            size="small"
              ...
              <List>
                    ...
                    <React.Fragment key={index}>
                      <ListItem className={classes.instruction}>
                        ...
                        <TextField
                          ...
                          id={`step-${index + 1}`}
                          value={step}
                          onChange={onStepChangeMaker(index)}
                ...
                <ListItem style={{ padding: 0 }}>
                  <Button
                    ...
                    startIcon={<Add style={{ width: 28, height: 28 }} />}
                    variant="contained"
