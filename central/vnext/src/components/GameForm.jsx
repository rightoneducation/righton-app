...
function GameForm({ loading, game, gameIndex, saveGame, deleteQuestion }) {
  ...
  const changeQuestionIndex = (currentIndex, newIndex) => {
    ...
    saveGame(newGame).then(() => history('/games/1'));
    setAnchorEl(null);
    setActiveIndex(null);
  };
  const addQuestion = () =>
    history(`/games/${gameIndex}/questions/${questions.length + 1}/edit`);
  ...
  return (
    <>
      <Box className={classes.actions}>
        ...
        <h3
          style={{ width: '10%', textAlign: 'center', textDecoration: 'und' }}
        >
          <strong>Games</strong>
        </h3>
        {game.grade !== 'General' && <>{/* <CCSS game={game} /> */}</>}
        <Button
            ...
            return (
              <Grid item xs={6}>
                <Paper
                  ...
                  onClick={() =>
                    history(`/games/${gameIndex}/questions/${index}`)
                  }
                >
                  <Box>
                    <CCSS
                    ...
                    <Box className={classes.questionIndex}>
                      <Typography variant="h9">Question {index + 1}</Typography>
                    </Box>
                    ...
                    <Box>
                      ...
                      >
                        <MenuItem
                          onClick={() =>
                            history(
                              `/games/${gameIndex}/questions/${index}/edit`,
                            )
                          }
                        >
                          Edit
