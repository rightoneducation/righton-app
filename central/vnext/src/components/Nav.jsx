...
export default function PrimarySearchAppBar({
  ...
  const match = useMatch('/gameMaker');
      ...
      <AppBar className={classes.bar} position="static">
        <Toolbar>
          ...
          <Grid className={classes.container}>
            ...
            {(isUserAuth && isResolutionMobile && match) ||
            (isUserAuth && !isResolutionMobile) ? (
              <NavLink
                className={classes.link}
                id="GameMaker"
                to="/gamemaker/0"
...
const useStyles = (isResolutionMobile) =>
  makeStyles((theme) => ({
    grow: {
      flexGrow: 1,
    },
    ...
    link: {
      ...
      opacity: '0.5',
      alignItems: 'center',
      opacity: isResolutionMobile ? '1' : '0',
    },
    logoContainer: {
      display: 'flex',
      alignItems: 'center',
