...
import { AuthManager, Environment, IAuthManager, UserRole } from "@righton/networking"

const LogIn: React.FC<{handleUserAuth:(isLoggedIn:boolean)=>void, authManager: IAuthManager }> = ({handleUserAuth, authManager}) => {
