...
import { IAuthManager } from '@righton/networking'

const Confirmation: React.FC<{authManager: IAuthManager}> = ({authManager}) => {
  ...
  const handleSubmit = async (e: React.SyntheticEvent<Element, Event>) => {
    ...
    try {
      await authManager.confirmSignUp(email, String(code));
      setDisplayText(true);
    } catch (error) {
      console.log(error);
    }
