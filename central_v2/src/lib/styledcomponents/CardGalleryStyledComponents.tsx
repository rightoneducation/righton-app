...
export const MostPopularText = styled(Typography)<MostPopularTextProps>(({ theme, screenSize }) => ({
...
export const SearchedText = styled(Typography)< SearchedTextProps>(({ screenSize, theme }) => ({
  lineHeight: screenSize === ScreenSize.SMALL ? '36px' : '60px',
  fontFamily: 'Poppins',
  fontWeight: '700',
  fontSize: screenSize === ScreenSize.SMALL ? `${theme.sizing.mdPadding}px` : '40px',
...
export const GradesText = styled(Typography)< SearchedTextProps>(({ screenSize, theme }) => ({
...
export const ResultsLengthText = styled(Typography)< SearchedTextProps>(({ screenSize, theme }) => ({
  fontFamily: 'Poppins',
  fontWeight: '700',
...
export const NoResultsText = styled(Typography)<SearchedTextProps>(({ screenSize, theme }) => ({
