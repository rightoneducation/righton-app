...
export const updateDQwithImage = (
...
export const updateDQwithImageURL = (
  draftQuestion: CentralQuestionTemplateInput,
  inputUrl?: string,
  inputImage?: File,
): CentralQuestionTemplateInput => {
...
export const updateDQwithTitle = (
  ...
  return {
    ...draftQuestion,
    questionCard: { ...draftQuestion.questionCard, title: inputTitle },
  };
};

export const updateDQwithCCSS = (
  draftQuestion: CentralQuestionTemplateInput,
  inputCCSS: string,
): CentralQuestionTemplateInput => {
  if (
  ...
  return {
    ...draftQuestion,
    questionCard: { ...draftQuestion.questionCard, ccss: inputCCSS },
  };
};

export const updateDQwithQuestionClick = (
  draftQuestion: CentralQuestionTemplateInput,
): CentralQuestionTemplateInput => {
  return {
    ...draftQuestion,
    questionCard: { ...draftQuestion.questionCard, isCardComplete: false },
  };
};
