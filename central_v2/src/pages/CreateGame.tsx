...
import { Typography, Box, useTheme, styled, Paper, Stack, Grid, TextField, Button, Switch, IconButton, useMediaQuery } from '@mui/material';
import AddIcon from '@mui/icons-material/Add';
import { debounce } from 'lodash';
import { CentralQuestionTemplateInput, IncorrectCard, PublicPrivateType } from '@righton/networking';
...
import { buttonContentMap, ButtonType } from '../components/button/ButtonModels';
import { updateDQwithCorrectAnswerClick } from '../lib/helperfunctions/createquestion/CorrectAnswerCardHelperFunctions';
import { handleMoveAnswerToComplete, updateDQwithIncorrectAnswerClick, updateDQwithIncorrectAnswers } from '../lib/helperfunctions/createquestion/IncorrectAnswerCardHelperFunctions';
import { updateDQwithCCSS, updateDQwithImage, updateDQwithImageURL, updateDQwithQuestionClick, updateDQwithTitle } from '../lib/helperfunctions/createquestion/CreateQuestionCardBaseHelperFunctions';
    ...
    const handleBackToExplore = () => {
     ...
     const handleSaveQuestion = async () => {
        try {
          ...
          if (draftQuestion.questionCard.isCardComplete && draftQuestion.correctCard.isCardComplete && draftQuestion.incorrectCards.every((card: any) => card.isCardComplete)){
  ...
  return (
    <CreateGameMainContainer>
      <CreateGameBackground />
       ...
       {currentScreenSize === ScreenSize.SMALL || currentScreenSize === ScreenSize.MEDIUM && <Box style={{
        width: '100%', 
        maxWidth: '672px',
        display: 'flex',
        justifyContent: 'center', 
        ...
        <CreateGameGridContainer container wrap="nowrap">
          <Grid item sm md={1} lg={4} style={{ 
            display: 'flex', justifyContent: 'flex-end', alignItems: 'flex-start', paddingTop: '16px', gap: '20px'
            }}>
             { (currentScreenSize !== ScreenSize.SMALL && screenSize !== ScreenSize.MEDIUM) &&
          ...
          <Grid item sm={12} md={10} lg={4} style={{
              width: '100%',
                        maxWidth: '672px',
        ...
        <Stack direction="row" alignItems="center" spacing={2}>
          ...
          <IconButton sx={{ backgroundColor: '#02215f', "&:hover" : { backgroundColor: '#4056ca'},  borderRadius: "20%"}}><img alt="add-question" src={buttonContentMap[ButtonType.ADDSTEP].icon} /></IconButton>
        </Stack>
...
// {/**
//  *   /* card and save/discard row */
//             <Box sx={{ width: { xs: "100%", md: '665px'}, height: { md: '275px' }}}>
...
//                   <TextField id="gameTitle" type="text" placeholder="Game Title..."/>
//                   <TextField id="description" type="text" multiline rows={4} placeholder="Game Description..."/>
//                   <Stack spacing={1} direction="row">
//                   <Button endIcon={<ExpandMoreIcon />} variant="contained">Phase 1</Button>
//                   <Button endIcon={<ExpandMoreIcon />} variant="contained">Phase 2</Button>
//                   </Stack>
//                 </Stack>
//               </Grid>
...
//               <Grid item xs={12} md={6}>
//                 <Stack spacing={2} justifyContent="center" alignItems="center" direction="column" sx={{ backgroundColor: '#ccc', height: '100%',}} >
//                   {/* Icon start for buttons */}
...
//             {/* question count & add Icon */}
//           <Stack direction="row" spacing={2}>
            
//             <IconButton sx={{ borderRadius: 8, backgroundColor: "#02215f"}}>
//               <AddIcon sx={{ color: 'white' }}/>
//             </IconButton>
//           </Stack>
//           {/*  */}
//           <Stack direction="row" spacing={2} sx={{ marginTop: 2 }}>
//             <CentralButton buttonType={ButtonType.CREATEQUESTION} isEnabled smallScreenOverride />
//             <CentralButton buttonType={ButtonType.QUESTIONBANK} isEnabled smallScreenOverride />
//           </Stack>
//  */ }