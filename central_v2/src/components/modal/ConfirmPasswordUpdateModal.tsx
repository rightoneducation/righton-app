  ...
  return (
    <Fade in={isModalOpen} mountOnEnter unmountOnExit timeout={1000}>
      <IntegratedContainer elevation={12}>
        ...
        >
          <DragText style={{ fontFamily: 'Poppins', color: '#1B376F' }}>
            Confirm Password Change
          </DragText>
          <DragText
            sx={{ fontSize: '16px', fontWeight: 400, fontFamily: 'Rubik' }}
          >
            Are you sure you want to change password? This will require you to
            re-verify your email using a code sent to your account email.
          </DragText>
          <Box
            style={{
              display: 'flex',
          ...
          >
            <CentralButton
              isEnabled
              buttonType={ButtonType.CONFIRMSENDCODE}
