...
import { ScreenSize, CreateQuestionHighlightCard, StorageKey } from '../../lib/CentralModels';
import { TitleText, CreateGameSaveDiscardBoxContainer, CreateGameGridContainer, CreateGameSaveDiscardGridItem, CreateGameCardGridItem, GameCreateButtonStack, QuestionCountButton, AddMoreIconButton } from '../../lib/styledcomponents/CreateGameStyledComponent';
...
export default function CreateGameComponent({ 
    ...
    return (
        ...
        <GameCreateButtonStack>
          <CentralButton buttonType={ButtonType.CREATEQUESTION} isEnabled onClick={handleCreateQuestion} />
          <CentralButton buttonType={ButtonType.QUESTIONBANK} isEnabled onClick={handleOpenQuestionBank} />
        </GameCreateButtonStack>
      </>
    )
}