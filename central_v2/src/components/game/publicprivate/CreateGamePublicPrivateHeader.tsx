...
interface CreateGamePublicPrivateHeaderProps {
  handleBackClick: () => void;
  screenSize: ScreenSize;
}

export default function CreateGamePublicPrivateHeader({handleBackClick, screenSize }: CreateGamePublicPrivateHeaderProps) {
