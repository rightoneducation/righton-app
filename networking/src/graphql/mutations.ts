...
>;
export const deleteUnverifiedUser = /* GraphQL */ `mutation DeleteUnverifiedUser($input: DeleteUnverifiedUserInput) {
  deleteUnverifiedUser(input: $input)
}
` as GeneratedMutation<
  APITypes.DeleteUnverifiedUserMutationVariables,
  APITypes.DeleteUnverifiedUserMutation
>;
export const updateUserPass = /* GraphQL */ `mutation UpdateUserPass($input: UpdateUserPassInput) {
  updateUserPass(input: $input)
}
` as GeneratedMutation<
  APITypes.UpdateUserPassMutationVariables,
  APITypes.UpdateUserPassMutation
>;
