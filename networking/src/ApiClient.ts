    ...
    private static mapQuestions(awsQuestions: Array<AWSQuestion | null>): Array<IQuestion> {
        return awsQuestions.map(awsQuestion => {
            ...
            const question: IQuestion = {
                ...
                choices: isNullOrUndefined(awsQuestion.choices) ? [] : JSON.parse(JSON.stringify(awsQuestion.choices)),
                imageUrl: awsQuestion.imageUrl,
                instructions: isNullOrUndefined(awsQuestion.instructions) ? [] : JSON.parse(JSON.stringify(awsQuestion.instructions)),
