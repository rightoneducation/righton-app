...
import { 
  ...
  ListPublicGameDraftQuestionsQueryVariables,
  ListPublicGameDraftQuestionsQuery,
  ListPrivateGameDraftQuestionsQueryVariables,
  ListPrivateGameDraftQuestionsQuery,
