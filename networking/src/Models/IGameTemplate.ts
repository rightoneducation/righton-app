...
export interface IGameTemplate {
  ...
  draftPublicQuestionTemplates?: {questionTemplate: IQuestionTemplate | null, questionTemplateID: string}[]  | null,
  draftPrivateQuestionTemplates?: {questionTemplate: IQuestionTemplate | null, questionTemplateID: string}[]  | null,
