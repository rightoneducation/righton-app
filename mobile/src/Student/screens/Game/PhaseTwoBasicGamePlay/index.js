    ...
    return (
        <SafeAreaView style={styles.mainContainer}>
            ...
            <View style={styles.carouselContainer}>
                ...
                {gameSession?.currentState ===
                    GameSessionState.PHASE_2_DISCUSS ? (
                    <HorizontalPageView initialPage={1}> {/*style = {styles.smaller}*/}
                        <>
                ...
                {/* style = {styles.larger}
                    ...Single page carousel with correct answer and wrong answers
                    side by side
                    */}
            </View>
...
// To implement responsive layout, it might make sense to add a class for 
// media queries equivalent or greater to ipad mini size, as well as a class for
// anything below this size. Since the cards are themselves responsive, I think 
// the only change necessary would be to use these two classes to determine 
// wether or not the wrong answer cards should be displayed in a second carousel
// panel (in the case of the smaller screen size) or in a single carousel panel
// (in the case of the larger screen size). I've added a comment above for what
// this might look like in terms of using the media queries and a comment below
// for the media queries themselves.
