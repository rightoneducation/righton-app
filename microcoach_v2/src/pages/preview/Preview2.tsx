...
/**
 * Preview2 — how the pipeline works, shown on a real run.
 *
 * Where /preview dumps every field of a run for debugging, this page presents
 * the pipeline itself: the stages in the current iteration, every formula they
