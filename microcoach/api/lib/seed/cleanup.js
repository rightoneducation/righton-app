...
// ── List helpers ─────────────────────────────────────────────────────────────
async function listAll(label, listQuery, dataKey, limit = 1000) {
    var _a, _b;
...
// ── Delete helpers ───────────────────────────────────────────────────────────
async function deleteAll(items, deleteMutation, label) {
    if (items.length === 0) {
...
async function main() {
    ...
    const total = studentResponses.length + activities.length + misconceptions.length +
